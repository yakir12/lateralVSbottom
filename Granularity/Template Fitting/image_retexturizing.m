...
clear all;
close all;
cd('/Users/dtaniguchi/Documents/Cuttlefish Project/lateralVSbottom/Granularity/Template Fitting')
...
final_img_edge = edge(final_img, 'prewitt');%find edges of image fit to template 
rv = [];
cv = [];
